...
-- usertbl이 첫번째 테이블이 되고, buytbl이 두번째 테이블 되어서 
...
-- 바로 userid때문이다. userid는 buytbl, usertbl 두 개의 테이블에 
...
-- 단점은 쿼리문이 상당히 길어진 것을 볼 수가 있다.이럴때 테이블에 알리아스를 주어서
-- 쿼리를 줄일 수 있다.
